...
<body>
    <h1 align='center' style="margin: 15px; color:blue;font-weight: bold;font-family:'Times New Roman', Times, serif">COURIER SERVICE</h1>
    <hr />
    <P align='center' style="font-weight: bold;color:black;font-family:'Times New Roman', Times, serif">The Fastest Courier Service Ever</P>
    <div>
